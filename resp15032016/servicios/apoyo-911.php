            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8">                       
                        ...
                        <div class="col-sm-4">
                            <p class="cuerpo-txt">
                                </p><h3>Manuales de Asistencia</h3>
                                <div class="uprofile-buttons">
                                    <a class="btn-comprar" href="data/pdf/asistencia_medica.pdf" target="_blank"><i class="fa fa-cloud-download"></i> Asistencia Médica</a><br>
                                    <a class="btn-comprar" href="data/pdf/asistencia_vial.pdf" target="_blank"><i class="fa fa-cloud-download"></i> Asistencia Vial</a><br>
                                    <a class="btn-comprar" href="data/pdf/asistencia_legal.pdf" target="_blank"><i class="fa fa-cloud-download"></i> Asistencia Legal</a><br>
                                    <a class="btn-comprar" href="data/pdf/asistencia_hogar.pdf" target="_blank"><i class="fa fa-cloud-download"></i> Asistencia en el Hogar</a><br>
                                    <a class="btn-comprar" href="data/pdf/tabla_asistencias_911.pdf" target="_blank"><i class="fa fa-cloud-download"></i> Ver tabla general de Beneficios</a>
                                </div>
                            <p></p>
                        </div>
                </div>
