    ...
    <div class="wrapper">
        ...
        <section id="generico" class="ptb-sm-10 plr-0">
            <div class="container">
              ...
              <p><strong>SMS PAGAS TÚ</strong> te permite enviar un sms a otro usuario de comunidad Unefon y otras compañías móviles para que el mensaje de texto (sms) le sea cobrado.</p>
