...
<body class="full-intro">
    ...
    <div class="wrapper">
        ...
        <section id="tagline" class="wow fadeIn pt-50 ptb-sm-30">
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-12">
                        <h3 class="h3">Disfruta con Unefon el prepago claro y honesto.<br>
                         Es tiempo de cambiar tu compañía celular.</h3>
                    </div>
                </div>
        ...
        <section id="portabilidad" class="ptb-sm-10">
            <div class="row no-pddng">
                    ...
                    <div class="col-md-6 block2 bg-imgvideo">
                        ...
                        <!--img src="img/play_white.png" alt="play portabilidad video" width="100" height="100"-->
                        </a>
                     </div>
            </div>
        </section>
            ...
            <div class="row">
                <div class="container">
                    <div class="col-md-10 col-sm-10 col-xs-12">
                        <p class="port-copy to-landing">No lo pienses más y cámbiate ahora a <strong>Unefon.</strong><br>
                            <span class="redux-p">Comienza a disfrutar del mejor plan de prepago.</span></p>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-12">
                        <a class="mas_btn" href="portabilidad.php">Ver más</a>
                </div>
            </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="owl-carousel image-slider o-flow-hidden">
                            <div class="item">
                                <img src="img/full/promo1.png" alt="" />
                                <!-- Content -->
                    ...
                    <!-- End Content -->
                            ...
                            <div class="item">
                                <img src="img/full/promo2.png" alt="" />
                                <!-- Content -->
                    <div class="full-wraper">
                        <div class="content-caption light-color">
        ...
        <!-- CrossSaling Section -->
        <section id="cross" class="fadeIn ptb-30 text-center dark-color">
        <div class="row no-pddng">
        ...
        <!-- 3 column Content START -->
         <div class="row no-pddng">
                        <div class="col-md-12 col-sm-12 col-xs-12"><!--footer news-->
                            ...
                            <!--div class="col-md-4 col-sm-12 col-xs-12"><!--cuadro2-->
                                <!--div class="col-md-4 col-sm-2 col-xs-4 no-right">
                                    <img data-src="img/prefooter/comunidad_extendida.jpg" class="img-responsive" alt="comunidad_extendida.jpg" src="img/prefooter/comunidad_extendida.jpg" data-holder-rendered="true">
                                </div>
                                <div class="col-md-8 col-sm-10 col-xs-8">
                                    <h3 class="semi-bold">Comunidad Extendida AT&amp;T</h3>
                                    <p>Con la comunidad extendida podrás llamar a los números Iusacell, Unefon, Nextel, AT&amp;T y Cricket sin costo extra.</p>
                                    <a href="servicios/comunidad-extendida.html" class="pref-btn">Conoce más aquí</a>
                                </div-->
                            </div-->
