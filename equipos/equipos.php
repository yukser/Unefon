                ...
                <div class="row mt-60 hidden-sm hidden-xs">
                    ...
                    <div style="visibility: visible; animation-name: fadeIn;" class="wow fadeIn col-md-4 text-center animated">
                            <div class="sp-wrap pt-30 gallery-pager">
                            	...
                            	<?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima1 ."' class='aaction' >"."<img src='".$gbl_ima1."' title='".$gbl_nomequi."1"."' alt='".$gbl_nomequi."1"."' /></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima2 ."' class='aaction' >"."<img src='".$gbl_ima2."' title='".$gbl_nomequi."2"."' alt='".$gbl_nomequi."2"."' /></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima3 ."' class='aaction' >"."<img src='".$gbl_ima3."' title='".$gbl_nomequi."3"."' alt='".$gbl_nomequi."3"."' /></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima4 ."' class='aaction' >"."<img src='".$gbl_ima4."' title='".$gbl_nomequi."4"."' alt='".$gbl_nomequi."4"."' /></a>"; } ?>
                ...
                <div class="row hidden-md hidden-lg">
                    ...
                    <div class="col-md-6 mb-sm-60">
                        <div class="">
                            <!--Item Images-->
                            <div class="sp-wrap">
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima1 ."' class='aaction' >"."<img src='".$gbl_ima1."' alt='".$gbl_nomequi." 1"."' title='".$gbl_nomequi." 1"."'  height='' width='' ></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima2 ."' class='aaction' >"."<img src='".$gbl_ima2."' alt='".$gbl_nomequi." 2"."' title='".$gbl_nomequi." 2"."'  height='' width='' ></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima3 ."' class='aaction' >"."<img src='".$gbl_ima3."' alt='".$gbl_nomequi." 3"."' title='".$gbl_nomequi." 3"."' class='aaction' ></a>"; } ?>
                                <?php if($gbl_imapeq != ""){ echo "<a href='". $gbl_ima4 ."' class='aaction' >"."<img src='".$gbl_ima4."' alt='".$gbl_nomequi." 4"."' title='".$gbl_nomequi." 4"."' class='aaction' ></a>"; } ?>
                            </div>
                            <!-- End Item Images -->
