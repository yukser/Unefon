	...
	?>
        ...
        <div class="wrapper">
			...
			?>
                ...
                <section class="hero">
                    <!-- Intro Scroll Down -->
                    <div class="intro-scroll-down"> <a class=" scroll-down aaction" href="#portabilidad" aria-label="Continúa leyendo" title="Continúa leyendo" id="gifmouse"><span><span class="mouse"> <span class="mouse-dot"></span> </span> </span></a>
                    </div>
                                    ...
                                    <div class="container caption-hero light-color">
                                        <div class="inner-caption">
                                            <div class="center_slider">
                                                <div class="extend"><a href="promociones/recarga-200.php" class="btn btn-md btn-white" aria-label="Descubre la promoción de recarga 200." title="Descubre la promoció de recarga 200.">Conoce más aquí</a></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div role="main" id="content" tabindex="-1">
                  ...
                  <section id="tagline" class="pt-50 ptb-sm-30">
                      <div class="container">
                          <div class="row">
                              <div class="col-md-6">
                                <a href="#" tabindex="0" onClick="open_video()" aria-label="Video; ¡Hazte escuchar!" title="Video; ¡Hazte escuchar!" class="aaction" id="videosection">
                                  <span>
                                    <img class="playvideo_photo" src="img/unefon_campana_google_play_video_play.jpg" alt="Con Unefon puedes decir lo que quieras, cuando quieras." height="auto" width="auto" title="¿Aún vives con mamá?" />
                                  </span>
                                </a>
                              </div>
                              <div class="col-md-6">
                                  ...
                                  <h3 class="h3">Cuando tu papá<br>cree que está en onda.<br>Descubre por qué.<br><br>¡Hazte escuchar!</h3>
                              </div>
                          </div>
                      </div>
                  </section>
                  ...
                  <section id="portabilidad" class="ptb-sm-10">
                      <div class="row no-pddng">
                          ...
                          <div class="col-md-6 block2 bg-imgvideo">
                              <!--a class="cbox-playvideo" onClick="open_video()"></a-->
                          </div>
                      </div>
                  </section>
                  ...
                  <section id="megabullets">
                      <div class="row no-pddng">
                          <div class="col-md-3 megabullet1"><a href="#"><img src="img/megabullets/mg-bullet_1_portabilidad.png" alt="Obtén tu NIP de portabilidad" title="Obtén tu NIP de portabilidad" height="188" width="auto" /></a></div>
                          <div class="col-md-3 megabullet2"><a href="#"><img src="img/megabullets/mg-bullet_2_portabilidad.png" alt="Identifica al aseror de Portabilidad." title="Identifica al aseror de Portabilidad." height="188" width="auto" /></a></div>
                          <div class="col-md-3 megabullet3"><a href="#"><img src="img/megabullets/mg-bullet_3_portabilidad.png" alt="En 24 horas tu número será cambiado" title="En 24 horas tu número será cambiado" height="188" width="auto" /></a></div>
                          <div class="col-md-3 megabullet4"><a href="#"><img src="img/megabullets/mg-bullet_4_portabilidad.png" alt="Bienvenido a Unefon" height="188" title="Bienvenido a Unefon" width="auto" /></a></div>
                      </div>
                  </section>
                  ...
                  <section id="cambiate" class="wow fadeIn ptb-30 plr-0 ptb-sm-10">
                      <div class="row">
                          <div class="container">
                              ...
                              <div class="col-md-2 col-sm-2 col-xs-12"> <a class=" mas_btn" href="cambiate-a-unefon.php" aria-label="Cámbiate a Unefon" title="Cámbiate a Unefon" id="plusaction"><span>Ver más</span></a> </div>
                          </div>
                      </div>
                  </section>
                  ...
                  <section class="dark-bg">
                      <div class="container">
                          <div class="row">
                              <div class="col-md-12">
                                  <div id="owlCarousel" tabindex="0" role="region" class="owl-carousel image-slider o-flow-hidden">
                                      <div class="item">
                                        <img class="visible-sm visible-md visible-lg" src="img/full/promo1.png" alt="Trae tu numero de otra compañía y Unefon te regala hasta 200 de tiempo aire" title="Trae tu numero de otra compañía y Unefon te regala hasta 200 de tiempo aire" />
                                        <img onclick="location.href='promociones/recarga-200.php'" class="visible-xs" src="img/full/promo-200_mobil.png" title="Trae tu numero de otra compañía y Unefon te regala hasta 200 de tiempo aire" alt="Trae tu numero de otra compañía y Unefon te regala hasta 200 de tiempo aire" />
                                          <!-- Content -->
                                          <div class="full-wraper">
                                              <div class="content-caption light-color">
                                                <a href="promociones/recarga-200.php" class="btn-promos sdc-green xs-hidden" aria-label="Promoción recarga 200." title="Promoción recarga 200." id="slide200"><span>Conoce más aquí</span></a>
                                              </div>
                                          </div>
                                          <!-- End Content -->
                                      </div>
                                      <div class="item"> <img class="visible-sm visible-md visible-lg" src="img/full/promo2.png" alt="Activa tu chip con nosotros y te damos hasta 1800" title="Activa tu chip con nosotros y te damos hasta 1800" />
                                        <img onclick="location.href='promociones/1800.php'" class="visible-xs" src="img/full/promo-1800_mobil.png" alt="Activa tu chip con nosotros y te damos hasta 1800" title="Activa tu chip con nosotros y te damos hasta 1800" />
                                          <!-- Content -->
                                          <div class="full-wraper">
                                              <div class="content-caption light-color">
                                                <a href="promociones/1800.php" class="btn-promos sdc-blue xs-hidden" aria-label="Promoción 1800." title="Promoción 1800.">Conoce más aquí</a> </div>
                                          </div>
                                          <!-- End Content -->
                                      </div>
                                  </div>
        ...
        <section id="cross" class="fadeIn text-center dark-color">
            <div class="row no-pddng">
                <div class="col-md-6 equipo ptcross">
                    ...
                    <a href="tiendas/index.php" class="btn btn-md btn-white" aria-label="Dónde Comprar Unefon." title="Dónde Comprar Unefon." id="csdonde"><span>Donde comprar</span></a> </div>
                <div class="col-md-6 donde ptcross">
                    ...
                    <a href="comprar/recarga-tiempo-aire.php" class="btn btn-md btn-white" aria-label="Dónde Recargar" title="Dónde Recargar" id="csrecarga"><span>Ver puntos de recarga</span></a> </div>
            </div>
            <!-- End work Filter -->
        </section>
        <!-- End Cross Section -->
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-8 col-sm-10 col-xs-8">
                            ...
                            <a href="servicios/facebook-switch.php" class="aaction pref-btn" aria-label="Conce Facebook Switch." title="Conce Facebook Switch." id="faceswitch">Conoce más aquí</a> </div>
                    </div>
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <!--cuadro2-->
                        ...
                        <div class="col-md-8 col-sm-10 col-xs-8">
                            ...
                            <a href="http://www.gsma.com/latinamerica/es/nosimporta" target="_blank" class="aaction pref-btn" aria-label="Nos importa México." title="Nos importa México." id="importamex">Conoce más aquí</a> </div>
                    </div>
                </div>
            </div>
