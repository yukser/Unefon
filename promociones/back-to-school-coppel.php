        ...
        <div class="container">
            <div class="row title">
                ...
                <div class="col-xs-8 col-sm-8 col-md-6">
                    <h2 class="h2" style="border-bottom: 3px solid #ffc600; color: #fff; padding-bottom: 15px; width: 80%;">Back to School <br>es volver más cool.</h2>
                </div>
                <div class="col-xs-4 col-sm-4 col-md-5">
                    <img class="img-responsive img-align" src="../img/promos/mochila.png" alt="Back to School mochila" title="Back to School mochila">
                </div>
    ...
    <section id="generico" class="ptb-sm-10 plr-0">
        <div class="container">
            ...
            <div class="row">
                ...
                <h1>Regresa a clases estrenando</h1>
                    <h2 class="emulate"><span>En la compra de un equipo Unefon</span> participas para <span>ganar bicicletas, notebooks o tablets.</span></h2>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <img class="img-responsive" src="../img/promos/bici.png" alt="Back to School Bici" title="Back to School Bici">
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <img class="img-responsive" src="../img/promos/laptop.png" alt="Back to School Laptop" title="Back to School Laptop">
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <img class="img-responsive" src="../img/promos/tablet.png" alt="Back to School Tablet" title="Back to School Tablet">
                </div>
                <br>
                <br>
                <div class="col-md-8 col-md-offset-2 fadeIn ptcross text-center">
                        <a href="../data/pdf/registro-promocion-back-to-school-coppel.pdf" target="_blank" class="btn-comprar" aria-label="Consulta aquí las bases" title="Consulta aquí las bases">Consulta aquí las bases</a>
                </div>
            </div>
                    <div class="row">  
