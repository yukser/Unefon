...
<body class="full-intro">
    ...
    <div class="wrapper">
            ...
            <div class="container">
                <div class="row title">
                    ...
                    <div class="page-breadcrumb">
                        <span style="color:#2d2d2d;"><a href="../index.php" style="color:#2d2d2d;"> Inicio</a> > <a href="index.php" style="color:#2d2d2d; font-weight:100;">Promociones</a> > Lealtad</span>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-care mecanica">
                    <h1>Premiamos tu lealtad al momento</h1>
                     <h2>Aprovecha nuestro atractivo Plan de Lealtad y obtén tiempo aire  para que disfrutes navegando más, ¡recuerda que entre más antigüedad tengas mayor es la recompensa!</h2>
                        <p>Mecánica:</p>
                             <ol>
        ...
        <div class="col-md-12 promos-legales plr-0">
            <p class="justify">
                <strong>Promoción válida al 30 de septiembre del 2016.</strong>
