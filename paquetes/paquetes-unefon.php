...
<head>
    ...
    <meta name="keywords" content="paquetes, planes unefon, unefon planes, paquetes unefon, tarifas unefon"/>
	<meta name="description" content="Con Unefon encuentra el paquete a tu medida, incluyen redes sociales, megas para navegar y minutos, todo con una sóla recarga."/>    
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    
    <!-- Facebook Tags -->    
    <meta property="og:url" content="http://www.unefon.com.mx/paquetes/paquetes-unefon.php" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Paquetes Unefon - Redes sociales, minutos y mensajes" />
    <meta property="og:description" content="Con Unefon encuentra el paquete a tu medida, incluyen redes sociales, megas para navegar y minutos, todo con una sóla recarga." />
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pt-care">
                    ...
                    <div class="col-lg-6 col-md-6 hidden-sm col-xs-12">
                      <img src="../img/full/oferta-banner2.jpg" alt="oferta Unefon" title="oferta Unefon" width="auto" height="auto">  
                    </div>
                </div>
        </section>
            ...
            <div class="container"><!-- container -->
                ...
                <div clas="row"><!-- row -->
                    ...
                    <div class="col-md-12 plr-0"><!-- Recargas -->
                        ...
                        <div class="col-md-12 plr-0"><!-- Col-md-12 -->
                            ...
                            <div class="num-gratis hidden-xs hidden-sm visible-lg visible-md"><!-- Número GRATIS -->
                                <p class="ng-texto" style="color: #2d2d2d;"><span class="cinco-gigante" >5</span>números gratis<sup>(4)</sup></p>
                            </div>
                            ...
                            <div class="rprip"><!-- Radio Prip -->
                                <p style="color: #2d2d2d;">Radio Prip $0.01 x seg</p>
                            </div>

                        <div class="dias-recarga"><!-- Días limite -->
                                <p style="color: #2d2d2d;">5 días</p>
                        </div>
                        ...
                        <div class="col-md-10 plr-0"><!-- Paquetes -->
                         <h3>Paquetes<sup>(2)</sup></h3>
                            ...
                            <div class="desk-hidden"><!-- Show in mobile -->
                                ...
                                <div class="dias-recarga"><p>5 días</p></div>
                            </div>
                                </div>
                            ...
                            <div class="desk-hidden"><!-- Show in mobile -->
                                ...
                                <div class="tab-redes-invert"><p>ilimitadas <sup>(6)</sup><i class="fa fa-facebook"></i> <i class="fa fa-twitter"></i> <i class="ion ion-social-whatsapp"></i></p></div>
                                <div class="tab-radio-prip"><p>Radio Prip Ilimitado<sup>(7)</sup></p></div>
                                <div class="dias-recarga"><p>10 días</p></div>
                            </div>
                                </div>
                            ...
                            <div class="desk-hidden"><!-- Show in mobile -->
                                ...
                                <div class="tab-redes-invert"><p>ilimitadas <sup>(6)</sup><i class="fa fa-facebook"></i> <i class="fa fa-twitter"></i> <i class="ion ion-social-whatsapp"></i></p></div>
                                <div class="tab-radio-prip"><p>Radio Prip Ilimitado<sup>(7)</sup></p></div>
                                <div class="dias-recarga"><p>25 días</p></div>
                            </div>
                                </div>
                            ...
                            <div class="col-md-12 plr-0 hidden_mobile"><!-- Llamadas y mensajes ilimitados -->
                                ...
                                <div class="tab-llamadas">
                                    <p class="llamadas-p-1" style="color: #2d2d2d;">Llamadas y mensajes MEX/USA/CAN</p>
                                    <p class="llamadas-p-2" style="color: #2d2d2d;">ilimitados<sup>(5)</sup></p>
                                </div>
                                ...
                                <div class="tab-radio-prip">
                                    <p style="color: #2d2d2d;">Radio Prip Ilimitado<sup style="color: #2d2d2d;">(7)</sup></p>
                                </div>
                            ...
                            <div class="col-md-12 plr-0 hidden_mobile"><!-- Días limite -->
                                 ...
                                 <div class="col-md-6 plr-0">
                                    <div class="col-md-3 recarga-col-1 plr-0"><p style="color: #2d2d2d;">5 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p style="color: #2d2d2d;">10 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p style="color: #2d2d2d;">25 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p>&nbsp;</p></div>
                                </div>

                                <div class="col-md-6 plr-0">
                                    <div class="col-md-9 recarga-col-5 plr-0"><p style="color: #2d2d2d;">30 días</p></div>
                                    <div class="col-md-3 recarga-col-4 plr-0" ><p style="color: #2d2d2d;">60 días</p></div>
                                </div>
                        </div>
                    ...
                    <div class="col-md-12 promos-legales plr-0">
                            ...
                            <div class="justify">
                           <strong> Promoción y oferta disponible al 23 de octubre de 2016.</strong> Aplica únicamente para dispositivos móviles con tecnología GSM, HSPA y/o 4G (LTE); Aplica política de uso justo, disponible para tu consulta <a href="../legales/politica-uso-justo.php" target="_blank" aria-label="aquí" title="aquí">aquí</a>. 
<span class="blue">(1)</span> La recarga de $10 está sujeta a la disponibilidad del punto de venta; La tarifa dependerá de la recarga realizada, la tarifa de $10, $20 y $30 es de $0.75 por MIN/SMS/MB; La vigencia de la recarga y beneficios de $10, $20 Y $30 = 5 días 
<span class="blue">(2)</span> A partir de las recargas de $30 o más el abono se convierte de manera automática en paquetes de beneficios, que se puede utilizar en MIN/SMS/MB y además otorgan servicios ilimitados de redes sociales Facebook (Facebook Messenger), Twitter, Whatsapp y radio Prip®. Estos paquetes funcionan de manera similar a un plan, además te permite realizar compra de aplicaciones, contenido o cualquier otro escenario no incluido en los beneficios de la recarga; A partir de la recarga de $30 puedes aprovechar tu bolsa de dinero para navegar más. La vigencia de los beneficios de $50 = 10 días, de $100 =25 días, de 150 a $500 = 30 días y los de $1,000 = 60 días. 
...
<span class="blue">(4)</span> El usuario podrá registrar cualquier número de cualquier compañía de México, Estados Unidos y Canadá como número gratis para llamar y enviar mensajes ilimitadamente, se activa por primera vez sin costo marcando al 050, los cambios posteriores tienen un costo de $49 por número. 
<span class="blue">(5)</span> Los minutos y/o mensajes todo destino ilimitados aplican para llamadas salientes a cualquier número de cualquier compañía de México, Estados Unidos y Canadá. 
<span class="blue">(6)</span> El uso de las redes sociales aplica únicamente cuando el usuario se encuentre dentro de las aplicaciones Facebook (incluye Facebook Messenger), Twitter y Whatsapp instaladas en el Smartphone; Cualquier acceso a ligas externas, llamadas de voz o video-llamadas por cualquier aplicación se contabilizará como consumo adicional y se debitará del Tiempo Aire o Saldo de Be-neficios y se cobrará de acuerdo a la tarifa del paquete seleccionado. La recarga de $10 - $20 in-cluye Whatsapp y las recargas de $30 o más incluyen Facebook, Twitter y Whatsapp. 
<span class="blue">(7)</span> Para hacer uso del Radio Prip®, deberás descargar la aplicación Radio Prip® (la descarga consume datos); el servicio sólo está disponible para equipos con sistema operativo Android v.4.0 o superior y iOS 7 o superior. En recargas de $10 a $20 el consumo de Radio es bajo demanda a $0.06 por 6 segundos de uso, a partir de la recarga de $30 en adelante radio Prip® es ilimitado durante la vigencia de los beneficios. PRIP es una marca registrada de NII Holdings, INC. Precios Incluyen IVA.
