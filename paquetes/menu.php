    ...
    <div class="container">
        ...
        <div class="container second-menu-top">
            <ul>
                ...
                <li><a tabindex="0" href='<?php echo $relativa;  ?>cobertura' aria-label="Cobertura" title="Cobertura" id="menucobert" ><span>Cobertura</span></a></li>
                <li><a href="#" class="toggle-menu menu-right push-body active" aria-label="Atención-a-Clientes" title="Atención a Clientes" id="menuatemcion" class="aaction"><span>Atención a Clientes</span></a></li>
            </ul>
            <a href="https://web.iusacell.com.mx/PortalAutoservWeb/miUnefon.jsp" target="_blank" class=" autoservicio" aria-label="Autoservicio" title="Autoservicio" id="menuauto"><span><i class="fa fa-user"></i> Autoservicio</span></a>
        </div>
        <!--End Search menu Top -->
        ...
        <nav role="navigation" class='navigation'>
            <ul role="menubar" aria-controls="st1">
                ...
                <li id="mb1_menu2" role="menuitem">
                	 <a href='<?php echo $relativa;  ?>equipos' aria-label="Equipos" title="Equipos" id="menuequipos" class="aaction linem"><span>Equipos</span></a>
                </li>
                <li role="menuitem" >
                ...
                <li id="mb1_menu5" role="menuitem">
                    ...
                    <!-- Nav Dropdown -->
                    <ul role="menu" aria-hidden="true" class="nav-dropdown">
                        <li role="menuitem"><a href="<?php echo $relativa;  ?>tiendas" aria-label="Ubica tu tienda" title="Ubica tu tienda" class="aaction"><span>Ubica tu tienda</span></a></li>
