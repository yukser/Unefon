        ...
        <section id="tabla-oferta" class="ptcontent ptb-sm-10">
            <div class="container"><!-- container -->
                ...
                <div clas="row"><!-- row -->
                        ...
                        <div class="col-md-10 plr-0"><!-- Paquetes -->
                         <h3>Paquetes<sup>(2)</sup></h3>
                            ...
                            <div class="desk-hidden"><!-- Show in mobile -->
                                ...
                                <div class="tab-redes-invert"><p>ilimitadas <i class="fa fa-facebook"></i> <i class="fa fa-twitter"></i> <i class="ion ion-social-whatsapp"></i></p></div>
                    ...
                    <div><p>* Promoción vigente del 21 de enero al 31 de julio del 2016</p></div>

                    <div class="col-md-12 promos-legales plr-0">
                                <h5>Legales</h5>
                                <div class="justify">
                                    <p>Oferta disponible al 31 de Julio de 2016. Aplica únicamente para dispositivos móviles con tecnología GSM, HSPA y/o 4G (LTE); 
                                        Aplica política de uso justo, disponible para tu consulta en la página: <a href="home.php">www.unefon.com.</a><br>
                                        <span class="blue">(1)</span> La recarga de $10 está sujeta a la disponibilidad del punto de venta; La tarifa dependerá de la recarga realizada, la tarifa de $10 , $20 y $30 
                                        es de $0.75 por MIN/SMS/MB; La vigencia de la recarga y beneficios de $10, $20 Y $30 = 7 días 
                                        <span class="blue">(2)</span> A partir de las recargas de $30 o más el abono se convierte de manera automática en paquetes de beneficios, que se puede utilizar en MIN/SMS/MB y 
                                        además otorgan servicios ilimitados de redes sociales Facebook (Facebook Messenger), Twitter, Whatsapp y radio Prip®. Estos paquetes funcionan de 
                                        manera similar a un plan, además te permite realizar compra de aplicaciones, contenido o cualquier otro escenario no incluido en los beneficios 
                                        de la recarga; A partir de la recarga de $30 puedes aprovechar tu bolsa de dinero para navegar más. La vigencia de los beneficios de $50 es de 15 días, 
                                        de $100 a $500 = 30 días y los de $1,000 = 60 días. 
                                        ...
                                        <span class="blue">(4)</span> El usuario podrá registrar cualquier número de cualquier compañía de México, Estados Unidos y Canadá como número gratis para llamar y enviar mensajes
                                        ilimitadamente, se activa por primera vez sin costo marcando al 050, los cambios posteriores tienen un costo de $49 por número. 
                                        ...
                                        <span class="blue">(6)</span> El uso de las redes sociales aplica únicamente cuando el usuario se encuentre dentro de las aplicaciones Facebook (incluye Facebook Messenger), Twitter y Whatsapp 
                                        instaladas en el Smartphone; Cualquier acceso a ligas externas, llamadas de voz o video-llamadas por cualquier aplicación se contabilizará como consumo adicional y 
                                        se debitará del Tiempo Aire o Saldo de Beneficios y se cobrará de acuerdo a la tarifa del paquete seleccionado. 
                                        La recarga de $10 - $20 incluye Whatsapp y las recargas de $30 o más incluyen Facebook, Twitter y Whatsapp. 
                                        <span class="blue">(7)</span> Para hacer uso del Radio Prip®, deberás descargar la aplicación Radio Prip® (la descarga consume datos); el servicio sólo está disponible para equipos con sistema operativo 
                                         Android v.4.0 o superior y iOS 7 o superior. En recargas de $10 a $20 el consumo de Radio es bajo demanda a $0.06 por 6 segundos de uso, a partir de la recarga de $30 en adelante 
                                         radio Prip® es ilimitado durante la vigencia de los beneficios. Precios Incluyen IVA.<br>
                                         <br>
