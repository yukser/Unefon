                        ...
                        <div class="line-separator"></div>           
                         ...
                         <div class="line-separator"></div>            
                            ...
                            <ul class="container-filter categories-filter">
                                ...
                                <li><a class="categories" id=".2g" onClick="filtrared(this.id)">2G</a></li>
                                <li><a class="categories" id=".3g" onClick="filtrared(this.id)">3G</a></li>
                                <li><a class="categories" id=".4g" onClick="filtrared(this.id)">4G</a></li>
                            </ul>
