...
/*
  ...
  */
  ...
  $(document).ready(function(){
	...
	//Seccion para deteccion del sistema operativo
	var isMobile = {
			Android: function() {
		...
		if(isMobile.iOS()) {
			osdetection ="https://goo.gl/I6m3ta";
			$(".dec_andr").fadeOut("fast");		
		}else if(isMobile.Android()){
			osdetection ="https://goo.gl/6l76pP";
			$(".dec_ios").fadeOut("fast");
		}else {
			osdetection ="https://web.iusacell.com.mx/PortalAutoservWeb/miUnefon.jsp";
		}
		
		$("#superanchor").attr("href", osdetection);
		
		//Buscamos la imagen del pixel		
		/*var imgpixel = $("img").attr("src","//trk.clinch.co/trk?cid=rhgb7O&amp;country=MX&amp;type=equipment&amp;id=27").selector;
