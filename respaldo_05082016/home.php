    ...
    <div class="wrapper">
        ...
        <section class="hero">
            ...
            <div class="flexslider fullscreen-carousel hero-slider-1 parallax parallax-section1">
                <ul class="slides">
                 ...
                 <li>
                        <img class="xs-hidden sm-hidden"  src="img/full/UNF_Bn_home_slider_desktop_promo_mama.jpg" alt="dark_image" />
                        <img class="visible-xs" src="img/full/UNF_Bn_home_slider_mobile_promo_mama.jpg" alt="Promo día de las madres" />
                        <div class="overlay-hero">
                            <div class="container caption-hero dark-color">
                                <div class="inner-caption">

                                <div class="left_tslider menostop">
                                    <h2 class="h2-promo">De la emoción va a decir poco y gritar mucho.</h2>
                                    <p class="promo1-copy">Este 10 de mayo, di mucho con muy poco.</p>
                                    <h4 class="promociones_banner">Aprovecha que por el día de las madres, los mejores smartphones tienen increíbles descuentos.</h4>
                                    <div><a href="promociones/descuento-20.php" class="btn btn-md btn-white" style="margin-top: 8px;">Descúbrelo</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <li onclick="location.href='promociones/recarga-200.php'">
                        <img class="xs-hidden"  src="img/full/unefon-mainbanner-promo-200.png" alt="Recarga 200" draggable="false" />
                        <img class="visible-xs" src="img/full/unefon-mainbanner-promo-200-mobile.png" alt="Recarga 200" />
                        <div class="overlay-hero">
                            <div class="container caption-hero light-color">
                                <div class="inner-caption">
                                    <div class="center_slider">
                                    <div class="extend"><a href="promociones/recarga-200.php" class="btn btn-md btn-white">Conoce más aquí</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overlay-hero">
                            <div class="container caption-hero light-color">
                                <div class="inner-caption">
                                    ...
                                    <div class="extend"><a href="paquetes/paquetes-unefon.php" class="btn btn-md btn-white">Descúbrelo</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overlay-hero">
                            <div class="container caption-hero light-color">
                                ...
                                <div class="left_tslider">
                                    ...
                                    <p class="slider-copy">Con muy poco puedes decir mucho.</p>
                                    <div class="extend"><a href="cambiate-a-unefon.php" class="btn btn-md btn-white">Descúbrelo</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="overlay-hero">
                            <div class="container caption-hero light-color">
                                ...
                                <div class="left_tslider">
                                    ...
                                    <p class="slider-copy">Con muy poco puedes decir mucho.</p>
                                    <div class="extend"><a href="equipos/index.php" class="btn btn-md btn-white">Descúbrelo</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="tagline" class="pt-50 ptb-sm-30">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <a onClick="open_video()"><img class="playvideo_photo" src="img/unefon_campana_video_play.png" alt="unefon reproducir video" height="auto" width="auto">
                        </a>
                    </div>
                    <div class="col-md-6">
                        <h3 class="h3">Exprésate con una llamada, mensaje o un like! Con Unefon puedes decir lo que quieras, cuando quieras!<br>
                            <br>
                            ¡Hazte escuchar!</h3>
                    </div>
                </div>
...
<div id="contenedor_video" onClick="close_video()"><!--CONTENEDOR_VIDEO-->
          <div class="container">
            ...
            <center>
                ...
                <iframe width="1280" height="720" src="https://www.youtube.com/embed/F4WrqbU8TZ4" frameborder="0" allowfullscreen></iframe>
                </div>
            </center>
        </div>   
</div><!--Termina caja-->   
