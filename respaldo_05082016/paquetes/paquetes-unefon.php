...
<head>
    ...
    <meta property="og:description" content="En Unefon encontraras el paquete a tu medida, incluyen redes sociales, megas para navegar y minutos, todo con una sóla recarga." />
            ...
            <div class="container"><!-- container -->
                ...
                <div clas="row"><!-- row -->
                         ...
                         <h3>Paquetes<sup>(2)</sup></h3>
                            ...
                            <div class="col-md-12 plr-0 hidden_mobile"><!-- Días limite -->
                                 ...
                                 <div class="col-md-6 plr-0">
                                    <div class="col-md-3 recarga-col-1 plr-0"><p>5 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p>10 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p>25 días</p></div>
                                    <div class="col-md-3 recarga-col-2 plr-0"><p>&nbsp;</p></div>
                                </div>

                                <div class="col-md-6 plr-0">
                                    <div class="col-md-9 recarga-col-5 plr-0"><p>30 días</p></div>
                                    <div class="col-md-3 recarga-col-4 plr-0"><p>60 días</p></div>
                                </div>
                        </div>
                    ...
                    <div class="col-md-12 promos-legales plr-0">
                            ...
                            <div class="justify">
                           <strong> Promoción y oferta disponible al 31 de agosto de 2016.</strong> Aplica únicamente para dispositivos móviles con tecnología GSM, HSPA y/o 4G (LTE); Aplica política de uso justo, disponible para tu consulta <a href="../legales/politica-uso-justo.php" target="_blank" aria-label="aquí" title="aquí">aquí</a>. 
