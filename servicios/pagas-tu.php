...
<head>
    ...
    <meta name="keywords" content="sms pagas tu, mensajes, mensajes de texto, enviar mensajes sin saldo, servicios unefon"/>
	<meta name="description" content="El servicio SMS pagas tú, te permite enviar un SMS incluso si no tienes saldo."/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    
    <!-- Facebook Tags -->    
    <meta property="og:url" content="http://www.unefon.com.mx/servicios/pagas-tu.php" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Unefon - SMS pagas tu" />
    <meta property="og:description" content="El servicio SMS pagas tú, te permite enviar un SMS incluso si no tienes saldo." />
...
<body class="full-intro">
    ...
    <div class="wrapper">
        ...
        <!-- Intro Section -->
        <section class="inner-intro bg-img20 parallax">
            <?php  
...
<div class="spacer-30"></div>
        ...
        <section class="ptb-sm-10">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="tabs">
                            <ul>
                                <li><a href="#tabs-1" aria-label="¿Cómo funciona?" title="¿Cómo funciona?" class="aaction" id="funciona"><span>¿Cómo funciona?</span></a></li>
                                <li><a href="#tabs-2" aria-label="Contáctos frecuentes" title="Contáctos frecuentes" class="aaction" id="contactods"><span>Contactos frecuentes</span></a></li>
                                <li><a href="#tabs-3" aria-label="Contáctos bloqueados" title="Contáctos bloqueados" class="aaction" id="bloqueados"><span>Contactos bloqueados</span></a></li>
                            </ul>
                            <div class="ui-tab-content">
                                <div id="tabs-1">
                                    ...
                                    <li><p>Costo del servicio <strong>$2.00</strong> por mensaje aceptado por el remitente</p></li>
                                    </ul>
                                </div>
                                <div id="tabs-2">
                                    <ul>
                                        <li>A través de tus <strong>contáctos frecuentes</strong> puedes agregar números celulares de personas que deseas aceptar el cargo de <strong>$2</strong> en automático por cada <strong>SMS pagas tú</strong>, es decir:</li>
                            ...
                            <div id="tabs-3">
                             <ul>
                 <li>A través de <strong>contáctos bloqueados</strong> puedes agregar números celulares de personas que no deseas recibir mensajes de <strong>SMS pagas tú</strong>, es decir:</p>
                 </li>
                    ...
                    <div class="col-md-12 mt-30 plr-0">
                        <div class="accordion">
                            <div class="accordion-section restrictions">
                                <h5 class="aaction accordion-title" id="restric"><span>Conoce aquí las restricciones</span></h5>
            ...
            <li>El texto del SMS PAGAS TÚ no deberá exceder de los 160 caracteres</li>
                                    ...
                                    <p>Consulta el <a href="http://www.unefon.com.mx/data/pdf/registros_ift.pdf" target="_blank" aria-label="oferta comercial" title="oferta comercial">registro</a> de la oferta comercial <a href="http://rpc.ift.org.mx/rpc/" target="_blank" aria-label="IFT" title="IFT">aquí</a>.</p>
                                </div>
                            </div>
                            </div>
                        </div>
