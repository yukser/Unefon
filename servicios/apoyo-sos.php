...
<head>
    ...
    <title>UNEFON - Apoyo S.O.S.</title>
            ...
            <div class="container">
                ...
                <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pt-care">
                        <h1>Apoyo S.O.S.</h1>
                        <h2 class="port-copy">El apoyo S.O.S. te protege ante emergencias</h2>
                        <br>
                        <p>Si cuentas con un equipo prepago, plan híbrido PVC y PUC, solicita tu asistencia marcando <strong>*SOS (767)</strong>.</p>
            </div>
        </div>
    </div>
</section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-8">                       
                                ...
                                <br>
                                <h3>¿Cómo Activar?</h3>
                                <p class="cuerpo-txt">Envía un <strong>SMS con la palabra ALTA</strong> Y FORMA PARTE DE APOYO S.O.S.</p>
                                <br>
                                <h3>¿Cómo Cancelar?</h3>
