...
<body class="full-intro">
    ...
    <div class="wrapper">
                        ...
                        <div class="accordion">
                            <div class="accordion-section restrictions">
                                ...
                                <div class="accordion-content defualt-hidden">
                                    ...
                                    <br>
                                    <p>Consulta el <a href="http://www.unefon.com.mx/data/pdf/registros_ift.pdf" target="_blank" aria-label="registro" title="registro">registro</a> de la oferta comercial <a href="http://rpc.ift.org.mx/rpc/" target="_blank" aria-label="oferta comercia" title="oferta comercia">aquí</a>.</p>
                                </div>
                            </div>
                            </div>
                        </div>
        ...
        <!-- Scroll Top -->
        <a class="scroll-top" aria-label="Ir arriba" title="Ir arriba" >
