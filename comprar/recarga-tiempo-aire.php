            ...
            <div class="container">
                ...
                <div class="row">
                    <ul class="container-filter categories-filter">
                        <li><a class="categories active" data-filter="*" aria-label="Todos" title="Todos" id="idtodos"><span>Todos</span></a></li>
                        <li><a class="categories" data-filter=".recargabancomex" aria-label="Bancos" title="Bancos" id="idbanci"><span>Bancos</span></a></li>
                        <li><a class="categories" data-filter=".recargamex" aria-label="Puntos de Recarga" title="Puntos de Recarga" id="idpuntos"><span>Puntos de Recarga</span></a></li>
