        ...
        <h5>Atención a clientes.</h5>
         ...
         <ul class="list-unstyled">
             <li><i class="fa fa-home"></i> Línea directa:
                <a href="tel:+018003330050">018003330050</a></li>
             
             <li><i class="fa fa-user"></i> Desde tu Unefon:
                <a href="tel:+050">Marca 050</a></li>
             
             <li><i class="fa fa-suitcase"></i> Desde U.S.A: 
                <a href="tel:+018005590687">018005590687</a></li>
             <!--li>
             	<i class="unefon icon-android"></i> Descarga Mi Unefon <a href="https://play.google.com/store/apps/details?id=com.unefon.miunefon&hl=es_419" target="_blank">Android</a>.
             </li>
             <li>
             	<i class="unefon icon-appleinc"></i> Descarga Mi Unefon <a href="https://itunes.apple.com/mx/app/mi-unefon/id868285890?mt=8" target="_blank">IOS</a>.
             </li-->
